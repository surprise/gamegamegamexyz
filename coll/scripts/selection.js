...
function makeTrNormal(groupname) {
    var s = "";
    var indeces = algsGroups[groupname];
    s += "<tr><td class='collgrouptdUnsel' onclick='selectCollGroup(\""+groupname
...
function makeTr42(gn1, gn2) {
    ...
    s += "<tr>"+
        "<td class='collgrouptdUnsel' onclick='selectCollGroup(\""+gn1 +"\")' colspan='"+in1.length+"'><b>" + gn1 + "</b></td>"+
        "<td class='collgrouptdUnsel' onclick='selectCollGroup(\""+gn2 +"\")' colspan='"+in2.length+"'><b>" + gn2 + "</b></td>"+
        "</tr>";
    s += "<tr>";
...
/// iterates the collMap and highlights HTML elements according to the selection
function renderSelection()
{
    var s="";

    s += "<table class='colllayout'>";
    //s += "<tr><a onclick='selectAllNone()'>select all or none</a>";
    s += "<tr><td class='collgrouptdUnsel' onclick='selectAllNone()' colspan='6'><b>All Cases (40)</b> | selected: <span id='csi'></span></td></tr>";
